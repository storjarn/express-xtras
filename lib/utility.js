module.exports = function(app) {
    ...
    app.locals.siteName = pkg.appName;
    var App = app.locals;
    ...
    console.log("Using request data middleware");
    console.log("Using request end middleware");
    ...
    console.log("Using active menu middleware");
    var ActiveMenu = require('active-menu');
    var mainMenu = new ActiveMenu('mainMenu');
    mainMenu.setAttributes({class : 'menu', id : 'main-menu'});
